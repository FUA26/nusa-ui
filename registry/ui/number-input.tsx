...
function NumberInput({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-9 w-full items-center overflow-hidden rounded-md border border-input shadow-xs transition-[color,box-shadow] focus-within:border-ring focus-within:ring-[3px] focus-within:ring-ring/50",
    ...
    >
      <button
        ...
        className="flex h-full shrink-0 items-center justify-center border-r px-2 hover:bg-muted disabled:pointer-events-none disabled:opacity-50"
      >
      ...
      <button
        ...
        className="flex h-full shrink-0 items-center justify-center border-l px-2 hover:bg-muted disabled:pointer-events-none disabled:opacity-50"
      >
